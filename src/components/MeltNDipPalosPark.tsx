  ...
  return (
    <>
      ...
      <nav
        ...
        style={{
          transitionProperty:
            "background, backdrop-filter, WebkitBackdropFilter, padding-top, padding-bottom, transform",
          transform:
            visible || menuOpen ? "translateY(0)" : "translateY(-100%)",
...
export default function MeltNDipPalosPage() {
  ...
  const catItems =
    activeCategory === "All" ? UNIFIED_MENU : getMenuByCategory(activeCategory);
  const catLabel =
    activeCategory === "All"
      ? "All Items"
      : CATEGORY_DISPLAY[activeCategory]?.label || activeCategory;
  const catId =
    activeCategory === "All"
      ? "all"
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 z-[4] flex flex-col justify-end pointer-events-none">
          <div className="px-4 sm:px-12 xl:px-20 pb-8 sm:pb-12 lg:pb-16 pointer-events-auto">
            <div
            ...
            >
              ...
              >
                <button
                  ...
                  className="mnd-hero-cta-primary me-4 hover-target w-full sm:w-auto shrink-0"
                  style={{
                    background: MND.gold,
                    color: MND.ink,
      ...
      >
        <div className="mnd-bel-left flex flex-col justify-center px-8 sm:px-12 lg:px-16 xl:px-20 py-20 lg:py-28">
          ...
          <div className="mnd-bel-f flex justify-between w-full max-w-[400px] mt-12">
            {[
              ...
              <div key={label} className="flex items-center flex-1">
                <div className="flex flex-col py-2 px-2 sm:px-6 items-center w-full">
                  <div
                  ...
                  <div
                    className="mnd-bel-stat-label text-center"
                ...
                {i < arr.length - 1 && (
                  <div
                    className="h-10 w-px shrink-0 mnd-bel-stat-divider"
      ...
      >
        ...
        />
        <div className="relative z-10 px-5 sm:px-12 lg:px-20">
          {/* ── Header ── */}
          <div className="mnd-menu-hdr grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 lg:gap-16 items-end mb-10 lg:mb-20">
            <div>
              <div
                className="mnd-menu-f mnd-eyebrow-text-sm flex items-center gap-4 mb-4 lg:mb-5"
                style={{ color: MND.goldMuted }}
              >
                <span
                  className="w-8 h-px"
              ...
              <h2
                className="mnd-menu-h2 flex flex-col gap-1 mb-4 lg:mb-6"
                style={{ color: MND.ink }}
              >
                <span className="overflow-hidden block py-1">
            ...
            {/* Stats — mobile only (horizontal strip) */}
            <div
              className="mnd-menu-f flex lg:hidden items-center justify-between w-full py-4 px-1"
              style={{
                borderTop: `1px solid ${MND.border}`,
                borderBottom: `1px solid ${MND.border}`,
              }}
              ...
              {[
                ...
                <div key={label} className="flex items-center flex-1">
                  <div className="flex flex-col items-center w-full py-1">
                    ...
                    <span
                      className="mnd-menu-stat-label text-center"
                      style={{ color: MND.goldMuted, fontSize: "10px" }}
                    >
                      {label}
                    </span>
                  </div>
          ...
          {/* ── Category tabs ── */}
          <div className="mnd-menu-f flex flex-nowrap gap-2 mb-8 lg:mb-10 overflow-x-auto no-scrollbar snap-x snap-mandatory">
                ...
                <button
                  ...
                  style={{
                    ...
                    outline:
                      activeCategory === cat
                        ? "none"
                        : `1px solid ${MND.gold}25`,
                    boxShadow:
                      activeCategory === cat
                        ? `0 4px 20px ${MND.gold}30`
                        : "none",
                  }}
                >
          ...
          {/* ── Cards + view-more ── */}
          {(() => {
            const hasMore = catItems.length > visibleCount;
              ...
              <>
                ...
                {hasMore && (
                  <div
                    ...
                    style={{ marginTop: "-5vh", zIndex: 10 }}
                  >
                    <h4
                      className="font-serif font-light text-center mb-2 px-4"
                      style={{
                    ...
                    >
                      There&apos;s more on the{" "}
                      <em className="italic" style={{ color: MND.gold }}>
                        menu
                      </em>
                    </h4>
                    <p
                      className="font-light text-center mb-8 px-6"
                      style={{
                        fontSize: "14px",
                        color: MND.goldMuted,
                        maxWidth: "340px",
                    ...
                    >
                      Expand to browse the full selection.
                    </p>
                    <button
                      onMouseMove={onMag}
                      onMouseLeave={offMag}
                    ...
                    >
                      Showing {visibleCount} of {catItems.length} items
                    </p>
                  </div>
                )}
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="mnd-menu-glow-dot shrink-0"
                      style={{
                        background: MND.gold,
                  ...
                  <button
                    ...
                    onMouseLeave={offMag}
                    onClick={() => scrollTo("mnd-catering")}
                    className="mnd-menu-cta-btn group hover-target flex items-center gap-2"
                    style={{ background: MND.gold, color: MND.ink }}
                  >
                    Book Catering
                    <ArrowUpRight
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-[1200px] mx-auto">
          <div>
            ...
            >
              {/* Thumbnail — hidden once video plays */}
              {!showVideo && (
                <img
              ...
              {/* Dark gradient overlay — only on thumbnail state */}
              {!showVideo && (
                <div
                  ...
                  <div className="relative flex items-center justify-center mb-3 sm:mb-5 transition-transform duration-500 group-hover:scale-110">
                    ...
                    >
                      <div
                        ...
                        style={{
                          borderLeft: `clamp(12px, 3vw, 20px) solid ${MND.ink}`,
                        }}
                      />
                    </div>
                  </div>
                  <p
                    className="mnd-yt-play-label"
                    style={{ color: MND.bgWarm }}
                  >
                    Watch Video
                  </p>
              ...
              {/* iframe — only mounted when playing, fills the entire wrapper */}
              {showVideo && (
                <iframe
                  id="mnd-yt-frame"
        ...
        <div className="mnd-loc-left grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div className="flex flex-col items-start pt-4">
            ...
            <p
              ...
              style={{ color: MND.creamMuted }}
            >
              Located on Lagrange Road in Palos Park, a short drive from Lemont,
              Orland Park, Homer Glen, and Tinley Park.
            </p>
