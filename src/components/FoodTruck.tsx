...
export default function FoodTruck() {
    ...
    return (
        <section ref={containerRef} className="py-24 lg:py-32 px-8 sm:px-12 lg:px-20 bg-paper max-w-[1400px] mx-auto">
            <div className="mb-14">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {[
                    ...
                    <div key={label} className="ft-card opacity-0 p-8 rounded-[3px] bg-white border border-linen hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(26,122,110,0.06)] transition-all duration-[400ms] ease-out">
                        ...
                        <p className="text-[12px] font-medium tracking-[2px] uppercase text-teal mb-2">{label}</p>
