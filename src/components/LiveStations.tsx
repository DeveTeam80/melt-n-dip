    ...
    useIsomorphicLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            gsap.fromTo(".ls-image",
                ...
                { clipPath: "inset(0% 0% 0% 0%)", opacity: 1, filter: "blur(0px)", duration: 1.5, ease: "power3.inOut", scrollTrigger: { trigger: ".ls-image", start: "top 80%" } }
            );
        }, containerRef);
        return () => ctx.revert();
    }, []);
            ...
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                ...
                <div className="flex flex-col items-start order-2 lg:order-1">
                    ...
                    <h2 className="font-serif font-light text-paper tracking-tight flex flex-col gap-1 mb-6" style={{ fontSize: "clamp(38px, 4.5vw, 64px)", lineHeight: "1.05" }}>
                        <span className="overflow-hidden block py-1"><span className="ls-reveal-line block opacity-0">Live Dessert</span></span>
                        <span className="overflow-hidden block py-1"><span className="ls-reveal-line block opacity-0"><em className="italic text-amber pr-2">Stations.</em></span></span>
                    </h2>
                    ...
                    <div className="ls-fade-up opacity-0 flex flex-col gap-6 w-full">
                        {[
                            { Icon: ChefHat, title: "Staffed by Professionals", desc: "Our trained culinary team handles setup, live cooking, and seamless service." },
                            { Icon: Sparkles, title: "Aromatic Atmosphere", desc: "Fill your venue with the scent of warm Belgian chocolate and freshly baked pastry." }
                        ].map(({ Icon, title, desc }) => (
                            <div key={title} className="flex items-start gap-5 bg-white/5 border border-white/10 p-6 rounded-[3px]">
