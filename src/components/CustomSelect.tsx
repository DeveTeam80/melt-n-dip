...
export default function CustomSelect({
    ...
    const theme = {
        ...
        shadow: light ? "shadow-[0_16px_40px_rgba(0,0,0,0.4)]" : "shadow-[0_16px_40px_rgba(26,122,110,0.12)]"
    };

    return (
        <div ref={ref} className={`relative w-full select-none ${open ? "z-50" : "z-10"}`}>
            <div
                onClick={() => setOpen((o) => !o)}
            ...
            >
                <span className={`font-light text-[15px] transition-colors duration-300 ${value ? theme.text : theme.placeholder}`}>
                    {value || placeholder}
                </span>
                <ChevronDown
