...
import CateringAndSeasonal from "./CateringAndSeasonal";
    ...
    "@graph": [
      {
        ...
        description:
          "Chicago's premier dessert catering service. We specialize in premium Belgian chocolate fountains, live crepe stations, artisan gelato carts, and Halal custom sweet platters for corporate events and weddings.",
