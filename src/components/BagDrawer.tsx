  ...
  return (
    <div className="fixed inset-0 z-[200] flex justify-end">
      ...
      >
        ...
        >
          <h3
            className="font-serif font-light flex items-center gap-2"
            style={{ fontSize: "22px", color: "var(--color-ink)" }}
          >
        ...
        <div className="flex-1 overflow-y-auto px-8 py-6 flex flex-col gap-6">
          {bag.map((item) => (
            <div
              key={item.id}
              className="flex items-start justify-between gap-4 pb-4 border-b border-linen/50"
            >
          ...
          {bag.length === 0 && (
            <div className="py-20 text-center">
              <p className="text-teal/80 italic text-[15px]">
                Your bag is empty.
              </p>
            </div>
          )}
        ...
        >
          {bag.length > 0 && (
            <>
              ...
              >
                This is an approximate estimate. Final pricing depends on event
                location, timing, staffing, setup, menu customization, and
                availability. Call us to finalize your catering order.
              </p>

              <div className="flex flex-col gap-2.5">
                {/* Request Catering Quote button */}
                <button
                  onClick={() => {
                    onRequestQuote(); // existing — scrolls to form + prefills
                    onClose(); // ← ADD: closes the drawer
                  }}
                ...
                <button
                  onClick={() => {
                    ...
                    alert(
                      "Catering bag saved successfully! You can retrieve it anytime you return to this browser.",
                    );
                  }}
